									...
									<div class="card bg-degrade text-center width-800">
										...
										<div class="card-body">
											<div class="card-block">    
												<h2 class="white">Verification</h2>
                                                @if (session('status'))
                                                    <div id="stats" style="display: block;">
                                                        {{session('status')}}   
                                                    </div>
                                                @endif
                                                <form class="needs-validation" action="/registration/verification/action" method="post">
                                                    @csrf
                                                    <div class="form-row">
                                                       
                                                        <div class="col-md-12 mb-3">
                                                        <label for="validationTooltip01">Verification code</label>
                                                        <input type="text" class="form-control" id="code_verification" name="code_verification">
                                                        </div>
                                                    </div>
